...
extern {
    ...
    pub fn mosquitto_new(id: *const ::libc::c_char,
                         clean_session: u8,
                         obj: *mut ::libc::c_void)
    ...
    pub fn mosquitto_reconnect_async(mosq: *mut Struct_mosquitto) -> ::libc::c_int;
    ...
    pub fn mosquitto_loop(mosq: *mut Struct_mosquitto,
                          timeout: ::libc::c_int,
    ...
    pub fn mosquitto_loop_stop(mosq: *mut Struct_mosquitto, force: u8) -> ::libc::c_int;
    ...
    pub fn mosquitto_threaded_set(mosq: *mut Struct_mosquitto, threaded: u8) -> ::libc::c_int;
    ...
    pub fn mosquitto_tls_set(mosq: *mut Struct_mosquitto,
                             ...
                             pw_callback:
                                 ::std::option::Option<unsafe extern "C" fn(buf:
                                                           ...
                                                           -> ::libc::c_int>)
     -> ::libc::c_int;
    pub fn mosquitto_tls_insecure_set(mosq: *mut Struct_mosquitto, value: u8) -> ::libc::c_int;
    ...
    pub fn mosquitto_max_inflight_messages_set(mosq: *mut Struct_mosquitto,
                                               max_inflight_messages: ::libc::c_uint)
                                               -> ::libc::c_int;
    pub fn mosquitto_message_retry_set(mosq: *mut Struct_mosquitto,
                                       message_retry: ::libc::c_uint)
                                       -> ();
    pub fn mosquitto_user_data_set(mosq: *mut Struct_mosquitto, obj: *mut ::libc::c_void) -> ();
    pub fn mosquitto_socks5_set(mosq: *mut Struct_mosquitto,
                                ...
                                password: *const ::libc::c_char)
                                -> ::libc::c_int;
    pub fn mosquitto_strerror(mosq_errno: ::libc::c_int) -> *const ::libc::c_char;
    pub fn mosquitto_connack_string(connack_code: ::libc::c_int) -> *const ::libc::c_char;
    pub fn mosquitto_sub_topic_tokenise(subtopic: *const ::libc::c_char,
                                        topics: *mut *mut *mut ::libc::c_char,
                                        count: *mut ::libc::c_int)
                                        -> ::libc::c_int;
    pub fn mosquitto_sub_topic_tokens_free(topics: *mut *mut *mut ::libc::c_char,
                                           count: ::libc::c_int)
                                           -> ::libc::c_int;
    pub fn mosquitto_topic_matches_sub(sub: *const ::libc::c_char,
                                       ...
                                       result: *mut u8)
                                       -> ::libc::c_int;
    pub fn mosquitto_pub_topic_check(topic: *const ::libc::c_char) -> ::libc::c_int;
    pub fn mosquitto_sub_topic_check(topic: *const ::libc::c_char) -> ::libc::c_int;
}
